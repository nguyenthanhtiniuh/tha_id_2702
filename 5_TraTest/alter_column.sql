...
/****** Object:  StoredProcedure [dbo].[usp_TINNT_AddColums]    Script Date: 2026-09-18 9:53:28 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER PROCEDURE dbo.usp_TINNT_AddColums
    ...
    BEGIN
        ...
        BEGIN
            ...
            BEGIN
                ...
                SET @_StrExec
                    = @_StrExec
                      --+ N'DROP INDEX IX_B3' + @_DataCode + N'FinPlan_DocDate ON dbo.B3' + @_DataCode+ 'FinPlan; ' 
                      + N'ALTER TABLE ' + @_TableName_Alter + N' ALTER  COLUMN    ' + @_ColName + N'   ' + @_Type_ALTER+' ; '
                      --+ ' ' + N'CREATE NONCLUSTERED INDEX IX_B3' + @_DataCode + N'FinPlan_DocDate ON dbo.B3'+ @_DataCode + 'FinPlan (DocDate);' + @_nl
...
EXEC sp_help usp_TINNT_AddColums

EXEC dbo.usp_TINNT_AddColums @_TableName = N'B30LCDoc'
                           , @_Type = 'ALTER'
                           , @_DataType = 'numeric(18,2)'
                           , @_ColName = 'OriginalAmount'
                           , @_Auto_Exec = 1
