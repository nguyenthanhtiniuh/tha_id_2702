...
BEGIN 
	...
	-- Dư đầu dư cuối kỳ này kỳ trước, PS trong kỳ
	...
	-- PL BÁO CÁO KẾT QUẢ SXKD (THEO ĐVCS) - TT99
	-- cuối kỳ
	...
	-- Rep04 16. Chi tiết tình hình tăng giảm dự phòng phải thu ngắn hạn khó đòi
	...
	-- Rep05 17. Đầu tư nắm giữ đến ngày đáo hạn
	...
	-- Rep06 18. Trả trước cho người bán ngắn hạn
	...
	-- Rep09 21.Chi tiết tình hình tăng (giảm) dự phòng giảm giá hàng tồn kho
	...
	-- Rep12 24. Chi phí đi vay được vốn hóa
	...
	-- Rep13 25. Chi phí xây dựng cơ bản dở dang
	...
	-- Rep15 27. Đầu tư tài chính dài hạn
	...
	-- Rep17 29. Phải trả người bán ngắn hạn
	...
	-- Rep18 30. Người mua trả trước ngắn hạn
	...
	-- Rep19 31. Phải trả về cổ tức, lợi nhuận
	...
	-- Rep20 32. Thuế và các khoản phải nộp nhà nước
	...
	-- Rep21 33. Chi phí trả trước ngắn hạn
	...
	-- Rep25 37. Lợi ích cổ đông không kiểm soát
	...
	-- Rep28 39. Lợi ích cổ đông góp vốn
	...
	-- Rep33 44. Chi phí bán hàng và quản lý doanh nghiệp
	...
	-- Rep34 45. Thu nhập khác và chi phí
	...
	-- Rep36 47. Chi phí thuế TNDN hoãn lại
...
SET DATEFORMAT DMY
EXEC usp_Kqt_FinancialStatementsNote_TT99_HopNhat @_DocDate1 = '01/02/2026 00:00:00.000'
                                                , @_DocDate2 = '28/02/2026 00:00:00.000'
                                                , @_DocDate01 = '01/01/2026 00:00:00.000'
                                                , @_DocDate02 = '31/01/2026 00:00:00.000'
                                                , @_nUserId = 1213
                                                , @_LangId = 0
                                                , @_BranchCode = 'I01'
                                                , @_CurrencyCode0 = 'VND'